...
class AtlasPartnerLogos extends BlockBase {
  ...
  public function build() {
    ...
    $html = '<p><img src="' . $bsbi . '" class="partner-logo" style="width:100%"/></p>';
    $html .= '<p><img src="' . $ceh . '" class="partner-logo" style="width:100%"/></p>';
    $html .= '<p><img src="' . $brc . '" class="partner-logo" style="width:100%"/></p>';
