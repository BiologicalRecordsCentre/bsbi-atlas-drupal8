(function (global, factory) {
  ...
  function phenologyUpdate() {
    var phenologyRoot = ds$1.bsbi_atlas.dataRoot + 'bsbi/phenology/';
    var identifier = currentTaxon.identifier;
    var file = phenologyRoot + identifier.replace(/\./g, "_") + '.csv';
    d3.csv(file + '?prevent-cache=').then(function (data) {
      dataUpdate(data);
  ...
  function altlatUpdate() {
    var altlatRoot = ds$1.bsbi_atlas.dataRoot + 'bsbi/20210923/altlat/';
    var identifier = currentTaxon.identifier;
    var altlatdata = "".concat(altlatRoot).concat(identifier.replace(/\./g, "_"), ".csv");
