...
export function createConservation(sel) {
  ...
  $('<span>').text(' Rare - species recorded in 15 or fewer hectads in GB 2000-2019; scarce - species recorded in 16-100 hectads in GB 2000-2019.').appendTo($refs)
  $refs.append($('<br/>'))
  ...
  $('<span>').text(' Rare - species recorded in 10 or fewer hectads in Ireland 2000-2019; scarce - species recorded in 11-25 hectads in Ireland 2000-2019.').appendTo($refs)
  $refs.append($('<br/>'))
